...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SUNSET.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+60 123456789</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Sunset <span>Hotel</span><p class="logo_w3l_agile_caption">Your Dream Night</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SUN SET</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Sun Set</h3> 
							<h4>Book Your Hotel and Resort with SUNSET. No Booking Fee, No Hidden Charges. Easy Booking.<br>
							24-7 Service. No Transaction Fee. Cheap & Honest Price. Special Rates Everyday.</h4><br>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+60123456789</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNSET.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> CYBER JAYA, SELANGOR, MALAYSIA</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2019 SUNSET . All Rights Reserved | Design by <a href="index.php">SUNSET</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
